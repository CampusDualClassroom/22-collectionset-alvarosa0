...
public class Exercise {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("HashSet - Se añadió AAA: " + addedHash);
        System.out.println("Contenido HashSet:"); printSet(hashSet);
        System.out.println();

        Set<String> treeSet = createTreeSet();
        boolean addedTree = addElementToSet(treeSet, "ELEMENT AAA");
        System.out.println("TreeSet - Se añadió AAA: " + addedTree);
        System.out.println("Contenido TreeSet:");
        printSet(treeSet);
